...
---
This analytical report aims to segment clients' data by K-means unsupervised clustering. In order to conduct a precise customer analysis by comparing the relation between each cluster and each variable. <br>
